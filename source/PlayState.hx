	...
	override function stepHit()
	{
		...
		switch (curSong)
		{
		  ...
		  switch(curStep)
		  {
			...
			case 176:
				remove(boyfriend);
				boyfriend = new Boyfriend(770, 450,'bfora');
				boyfriend.y += 600;
				boyfriend.x += 200;
				add(boyfriend); 
				boyfriend.playAnim('idle');
			...
			case 320:
				...
				add(boyfriend);
			case 384:
				dad.playAnim('thrown',false); //it not finish yet
			...
			case 403:
				remove(dad);
				dad = new Character(100,100 ,'jackget');
				dad.x -= 600;
				dad.y += 800;
				add(dad);
				dad.playAnim('got', false);
			case 405:
				dad.playAnim('idle');
			case 416:
				remove(dad);
